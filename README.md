...
- 👨‍💼 Chairman — JIT ACM Student Chapter
...
🌐 [Live Website](https://www.hackblitz.in/)

💻 [GitHub Repository](https://github.com/Apex-ace/Hackblitz_3.0)

---

### 🛒 Electronics E-Commerce Platform

A full-stack electronics e-commerce application with a modern responsive interface and backend API.

**Tech:** React · Tailwind CSS · Node.js · Express · MongoDB

🌐 [Live Website](https://n-frontend.vercel.app/)

---

### 🎓 Training & Placement Management System

A college management system designed to manage student information, document verification, placement activities, and role-based administration.
